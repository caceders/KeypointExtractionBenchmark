...
class ShiTomasiSift():
    ...
    def __init__(self,
        ...
        if self.derivation_operator not in ["sobel", "prewitt", "scharr", "simple"]:
            raise ValueError(f"Invalid derivation operator: {self.derivation_operator}. Valid is 'sobel', 'prewitt', 'scharr' or 'simple'")
