...
for distance_threshold in tqdm(distance_thresholds, leave=False, desc="Calculating for all thresholds"):
    for keypoint_size_scaling in tqdm(keypoint_size_scalings, leave=False, desc="Calculating for all sizes"):
        for feature_extractor_key in tqdm(test_combinations.keys(), leave=False, desc="Calculating for all combinations"):
            ...
            try:
                ...
                set_numbers_of_possible_correct_matches, set_repeatabilities =  calculate_valid_matches(image_feature_set, dataset_homography_sequence, distance_threshold)
                ...
                results = {
                    "combination": f"{feature_extractor_key} {keypoint_size_scaling} {distance_threshold}",
                    "speed": speed,
